...
cards = {
    'AH': cv.imread('./hearts/AH.png', cv.IMREAD_GRAYSCALE),
    '2H': cv.imread('./hearts/2H.png', cv.IMREAD_GRAYSCALE),
    '3H': cv.imread('./hearts/3H.png', cv.IMREAD_GRAYSCALE),
    '4H': cv.imread('./hearts/4H.png', cv.IMREAD_GRAYSCALE),
    '5H': cv.imread('./hearts/5H.png', cv.IMREAD_GRAYSCALE),
    '6H': cv.imread('./hearts/6H.png', cv.IMREAD_GRAYSCALE),
    '7H': cv.imread('./hearts/7H.png', cv.IMREAD_GRAYSCALE),
    '8H': cv.imread('./hearts/8H.png', cv.IMREAD_GRAYSCALE),
    '9H': cv.imread('./hearts/9H.png', cv.IMREAD_GRAYSCALE),
    '10H': cv.imread('./hearts/10H.png', cv.IMREAD_GRAYSCALE),
    'JH': cv.imread('./hearts/JH.png', cv.IMREAD_GRAYSCALE),
    'QH': cv.imread('./hearts/QH.png', cv.IMREAD_GRAYSCALE),
    'KH': cv.imread('./hearts/KH.png', cv.IMREAD_GRAYSCALE),
    'AD': cv.imread('./diamonds/AD.png', cv.IMREAD_GRAYSCALE),
    '2D': cv.imread('./diamonds/2D.png', cv.IMREAD_GRAYSCALE),
    '3D': cv.imread('./diamonds/3D.png', cv.IMREAD_GRAYSCALE),
    '4D': cv.imread('./diamonds/4D.png', cv.IMREAD_GRAYSCALE),
    '5D': cv.imread('./diamonds/5D.png', cv.IMREAD_GRAYSCALE),
    '6D': cv.imread('./diamonds/6D.png', cv.IMREAD_GRAYSCALE),
    '7D': cv.imread('./diamonds/7D.png', cv.IMREAD_GRAYSCALE),
    '8D': cv.imread('./diamonds/8D.png', cv.IMREAD_GRAYSCALE),
    '9D': cv.imread('./diamonds/9D.png', cv.IMREAD_GRAYSCALE),
    '10D': cv.imread('./diamonds/10D.png', cv.IMREAD_GRAYSCALE),
    'JD': cv.imread('./diamonds/JD.png', cv.IMREAD_GRAYSCALE),
    'QD': cv.imread('./diamonds/QD.png', cv.IMREAD_GRAYSCALE),
    'KD': cv.imread('./clubs/./diamonds/KD.png', cv.IMREAD_GRAYSCALE),
    'AC': cv.imread('./clubs/AC.png', cv.IMREAD_GRAYSCALE),
    '2C': cv.imread('./clubs/2C.png', cv.IMREAD_GRAYSCALE),
    '3C': cv.imread('./clubs/3C.png', cv.IMREAD_GRAYSCALE),
    '4C': cv.imread('./clubs/4C.png', cv.IMREAD_GRAYSCALE),
    '5C': cv.imread('./clubs/5C.png', cv.IMREAD_GRAYSCALE),
    '6C': cv.imread('./clubs/6C.png', cv.IMREAD_GRAYSCALE),
    '7C': cv.imread('./clubs/7C.png', cv.IMREAD_GRAYSCALE),
    '8C': cv.imread('./clubs/8C.png', cv.IMREAD_GRAYSCALE),
    '9C': cv.imread('./clubs/9C.png', cv.IMREAD_GRAYSCALE),
    '10C': cv.imread('./clubs/10C.png', cv.IMREAD_GRAYSCALE),
    'JC': cv.imread('./clubs/JC.png', cv.IMREAD_GRAYSCALE),
    'QC': cv.imread('./clubs/QC.png', cv.IMREAD_GRAYSCALE),
    'KC': cv.imread('./spades/KC.png', cv.IMREAD_GRAYSCALE),
    'AS': cv.imread('./spades/AS.png', cv.IMREAD_GRAYSCALE),
    '2S': cv.imread('./spades/2S.png', cv.IMREAD_GRAYSCALE),
    '3S': cv.imread('./spades/3S.png', cv.IMREAD_GRAYSCALE),
    '4S': cv.imread('./spades/4S.png', cv.IMREAD_GRAYSCALE),
    '5S': cv.imread('./spades/5S.png', cv.IMREAD_GRAYSCALE),
    '6S': cv.imread('./spades/6S.png', cv.IMREAD_GRAYSCALE),
    '7S': cv.imread('./spades/7S.png', cv.IMREAD_GRAYSCALE),
    '8S': cv.imread('./spades/8S.png', cv.IMREAD_GRAYSCALE),
    '9S': cv.imread('./spades/9S.png', cv.IMREAD_GRAYSCALE),
    '10S': cv.imread('./spades/10S.png', cv.IMREAD_GRAYSCALE),
    'JS': cv.imread('./spades/JS.png', cv.IMREAD_GRAYSCALE),
    'QS': cv.imread('./spades/QS.png', cv.IMREAD_GRAYSCALE),
    'KS': cv.imread('./spades/KS.png', cv.IMREAD_GRAYSCALE),
}